...
public class StringReturnCheckAdderV1 extends ClassVisitor {
    private final String className;

    public StringReturnCheckAdderV1(int api, ClassVisitor classVisitor, String className) {
        ...
        MethodVisitor methodStringReturnCheckAdder = new MethodVisitor(Opcodes.ASM6, baseMv) {
            ...
            public void visitLdcInsn(Object value) {
                if (value instanceof String) {
                    Textifier textifier = new Textifier();
                    MethodVisitor tracer = new TraceMethodVisitor(mv, textifier);
                    tracer.visitLdcInsn(value); // takes care of super.visitMethodInsn
            ...
            // Check to see if any other instructions can put a String on the stack that wasn't already there.
        };
